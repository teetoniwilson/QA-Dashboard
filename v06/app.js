...
app.get("/lessonlearnedlogs/index", function(req, res)
		{
			...
			LessonlearnedLog.find({}, function(err,allLessonlearnedLog)
			{
				if(err)
					...
					{
						res.render("lessonlearnedlogs/index", {lessonslearned:allLessonlearnedLog});
					}				
			});
...
app.post("/lessonlearnedlogs", function(req, res)
		{
			var setImage = ""; 
			if(req.body.image =="")
				{
...
app.post("/lessonlearnedlogs/:id/comments/", function(req, res)
		 {
...
app.get("/lessonlearnedlogs/:id/comments/new", function(req, res) //NESTED Comment route
		{

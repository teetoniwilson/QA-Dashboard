...
//================================================ISSUE COUNT ROUTE======================================================//
router.get("/countRESET", function(req, res)
		{
			res.render("count");		
		});

//================================================PERFORMANCE ROUTE======================================================//
router.get("/performanceRESET", function(req, res)
		{
...
//================================================TREE ROUTE======================================================//
router.get("/iftree", function(req, res)
		{
			res.render("iftree");		
		});
...
router.post("/login", function (req, res, next)
			{
	         passport.authenticate("local",
				{
				  successRedirect: "/issuelogs/index",
  ...
  async.waterfall([
    ...
    function(token, user, done) {
      var smtpTransport = nodemailer.createTransport({
        service: 'Gmail', 
        auth: {
          user: 'awqadashboard@gmail.com',
          pass: process.env.GMAILPW
        }
      });
      var mailOptions = {
        to: user.email,
        from: 'awqadashboard@gmail.com',
        subject: 'SB-QA Dashboard Password Reset',

...
//======================== EDIT ROUTE=========================================================================//
router.get("/:id/edit",isLoggedIn,checkIssueLogOwnership, function(req, res)
		{
...
//======================UPDATE ROUTES=========================================================================//
router.put("/:id/", isLoggedIn, checkIssueLogOwnership, function(req, res)
		{
...
//=============================DELETE ROUTES=========================================================================//
router.delete("/:id",isLoggedIn,checkIssueLogOwnership, function(req, res)
		   {
...
function checkIssueLogOwnership (req, res, next)
{
	if(req.isAuthenticated())
		{
			Issuelog.findById(req.params.id, function(err, foundIssuelog)

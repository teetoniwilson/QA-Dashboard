const express           = require("express"),
	  ...
	  Appsection        = require("./models/appsection"),
	  TotalTestcase     = require("./models/totaltestcasecreated"),
...
appsectionsRoutes 		= require("./routes/appsections"),	  
...
const secret = process.env.SECRET || "It was all a dream!";
...
app.use(express.static(__dirname + "/public")); //__dirname refers to the directory that this script will run in
...
app.use("/appsections",appsectionsRoutes);
app.use("/",indexRoutes);
...
mongoose.connect('mongodb+srv://Toniodev:800dM0rn!n8@cluster0-shw8n.mongodb.net/test?retryWrites=true&w=majority', {
	...
	console.log('Connected to QA Dashboard DB!');
}).catch(err=>{

...
.attr('transform', `translate(${cent.x},  ${cent.y+20})`); // template strings used to output dynamic variables inside a string
...
var countText2 = svg2.append("text")
    .attr('transform', `translate(${cent.x-23},  ${cent.y+40})`)  
	.attr("class", "fa")
    .call(addNewIssueTip)
    .attr("font-size", '50px')
	
    .html(function (d) { return ('<a href="/issuelogs/new" style="text-decoration: none; fill:#1E90FF">\uf067</a>') })
...
.scale(color2);
    ...
    legendGroup.selectAll('text').attr('fill', '#6C757D');
